...
contract Travelhive_DAO is IPermissionManager {
    ...
    uint32[14] internal all_roles = [
        24576, // #0) Founder -> ID : 0 , control bitmask: 1100000000
        24577, // #1) Master_Node -> ID : 1 , control bitmask: 1100000000
        24578, // #2) Marketing_Delegate -> ID : 2 , control bitmask: 1100000000
        24579, // #3) Investor -> ID : 3 , control bitmask: 1100000000
        24580, // #4) Developer -> ID : 4 , control bitmask: 1100000000
        24581, // #5) Ambassador -> ID : 5 , control bitmask: 1100000000
        24582, // #6) DAO_Member -> ID : 6 , control bitmask: 1100000000
        24583, // #7) Advisor -> ID : 7 , control bitmask: 1100000000
 ...
 //Events
    ...
    constructor(
        ...
        role_permissions[0] = 51298496; // #0) Founder 

        role_permissions[1] = 202277056; // #1) Master_Node 

        role_permissions[2] = 4096704; // #2) Marketing_Delegate 

        role_permissions[3] = 13533376; // #3) Investor 

        role_permissions[4] = 202277056; // #4) Developer 

        role_permissions[5] = 4099264; // #5) Ambassador 

        role_permissions[6] = 950464; // #6) DAO_Member 

        role_permissions[7] = 51298496; // #7) Advisor 
