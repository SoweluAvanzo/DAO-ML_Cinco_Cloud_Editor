...
export const languageHandlingAction = async (
  filePath: string,
  opts: GenerateOptions,
  mode?: LanguageJobMode
): Promise<void> => {
  ...
  if (
    ...
    languageJobs.push({
      ...
      callable: async (errorDisplay) => {
        ...
        const result = await new MGLGenerator()
          .generateMetaSpecification(model, filePath, services)
          .catch((e) => {
