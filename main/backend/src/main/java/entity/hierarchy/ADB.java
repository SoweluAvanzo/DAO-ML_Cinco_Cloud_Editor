...
@Entity(name="entity_hierarchy_a")
public class ADB extends PanacheEntity {
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_a_talist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_adb_id") },
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_a_tblist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_adb_id") },
		inverseJoinColumns = { @javax.persistence.JoinColumn(name = "child_tadb_id") }
	)
	@javax.persistence.OneToMany
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_a_tclist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_adb_id") },
		inverseJoinColumns = { @javax.persistence.JoinColumn(name = "child_tadb_id") }
	)
	@javax.persistence.OneToMany
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_a_tdlist_td",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_adb_id") },
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_a_tdlist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_adb_id") },
		inverseJoinColumns = { @javax.persistence.JoinColumn(name = "child_tadb_id") }
	)
	@javax.persistence.OneToMany
