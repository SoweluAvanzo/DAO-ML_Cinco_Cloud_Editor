...
@Entity(name="entity_hierarchy_conta")
public class ContADB extends PanacheEntity {
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_conta_talist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_contadb_id") },
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_conta_tblist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_contadb_id") },
		inverseJoinColumns = { @javax.persistence.JoinColumn(name = "child_tadb_id") }
	)
	@javax.persistence.OneToMany
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_conta_tclist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_contadb_id") },
		inverseJoinColumns = { @javax.persistence.JoinColumn(name = "child_tadb_id") }
	)
	@javax.persistence.OneToMany
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_conta_tdlist_td",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_contadb_id") },
	...
	@javax.persistence.JoinTable(
		name = "entity_hierarchy_conta_tdlist_ta",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_contadb_id") },
		inverseJoinColumns = { @javax.persistence.JoinColumn(name = "child_tadb_id") }
	)
	@javax.persistence.OneToMany
	...
	@javax.persistence.OneToMany(mappedBy="container_ContA")
