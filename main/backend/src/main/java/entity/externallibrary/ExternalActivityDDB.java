...
@Entity(name="entity_externallibrary_externalactivityd")
public class ExternalActivityDDB extends PanacheEntity {
	...
	@javax.persistence.JoinTable(
		name = "entity_externallibrary_externalactivityd_recerencingabstractlist_externalactivityd",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_externalactivityddb_id") },
	...
	@javax.persistence.JoinTable(
		name = "entity_externallibrary_externalactivityd_recerencingabstractlist_externalactivitya",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_externalactivityddb_id") },
	...
	@javax.persistence.JoinTable(
		name = "entity_externallibrary_externalactivityd_referencinglist_externalactivitya",
		joinColumns = { @javax.persistence.JoinColumn(name = "parent_externalactivityddb_id") },
		inverseJoinColumns = { @javax.persistence.JoinColumn(name = "child_externalactivityadb_id") }
	)
	@javax.persistence.OneToMany
