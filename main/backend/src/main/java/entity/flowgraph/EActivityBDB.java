...
@Entity(name="entity_flowgraph_eactivityb")
public class EActivityBDB extends PanacheEntity {
	...
	@javax.persistence.OneToMany(mappedBy="target_EActivityB")
	...
	@javax.persistence.OneToMany(mappedBy="source_EActivityB")
	public java.util.Collection<entity.flowgraph.LabeledTransitionDB> outgoing_LabeledTransition = new java.util.ArrayList<>();
	
	@javax.persistence.ManyToOne
	public entity.externallibrary.ExternalActivityDDB activityD_ExternalActivityD;
	
	@javax.persistence.ManyToOne
	public entity.externallibrary.ExternalActivityADB activityD_ExternalActivityA;
	...
	public PanacheEntity getActivityD() {
		if(activityD_ExternalActivityD != null) {
			return activityD_ExternalActivityD;
		} else if(activityD_ExternalActivityA != null) {
			return activityD_ExternalActivityA;
		}
		return null;
	}
	
	public void setActivityD(PanacheEntity e) {
		setActivityD(e, false);
	}
	
	public void setActivityD(PanacheEntity e, boolean deleteOld) {
		// potencially delete all old elements
		if(deleteOld) {
			if(activityD_ExternalActivityD != null) {
				activityD_ExternalActivityD.delete();
			}
			if(activityD_ExternalActivityA != null) {
				activityD_ExternalActivityA.delete();
			}
		}
		...
		if(e instanceof entity.externallibrary.ExternalActivityDDB) {
			// null all other types
			activityD_ExternalActivityA = null;
			// set element
			activityD_ExternalActivityD = (entity.externallibrary.ExternalActivityDDB) e;
			return;
		} else if(e instanceof entity.externallibrary.ExternalActivityADB) {
			// null all other types
			activityD_ExternalActivityD = null;
			// set element
			activityD_ExternalActivityA = (entity.externallibrary.ExternalActivityADB) e;
			return;
		}
