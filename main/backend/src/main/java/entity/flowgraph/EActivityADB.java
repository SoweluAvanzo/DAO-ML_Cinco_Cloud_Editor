...
@Entity(name="entity_flowgraph_eactivitya")
public class EActivityADB extends PanacheEntity {
	...
	@javax.persistence.OneToMany(mappedBy="target_EActivityA")
	...
	@javax.persistence.OneToMany(mappedBy="source_EActivityA")
	public java.util.Collection<entity.flowgraph.LabeledTransitionDB> outgoing_LabeledTransition = new java.util.ArrayList<>();
	
	@javax.persistence.ManyToOne
	public entity.externallibrary.ExternalActivityADB activityC_ExternalActivityA;
	...
	public PanacheEntity getActivityC() {
		if(activityC_ExternalActivityA != null) {
			return activityC_ExternalActivityA;
		}
		return null;
	}
	
	public void setActivityC(PanacheEntity e) {
		setActivityC(e, false);
	}
	
	public void setActivityC(PanacheEntity e, boolean deleteOld) {
		// potencially delete all old elements
		if(deleteOld) {
			if(activityC_ExternalActivityA != null) {
				activityC_ExternalActivityA.delete();
			}
		}
		...
		if(e instanceof entity.externallibrary.ExternalActivityADB) {
			// null all other types
			// set element
			activityC_ExternalActivityA = (entity.externallibrary.ExternalActivityADB) e;
			return;
		}
		
		// default-case
		// null all types
		activityC_ExternalActivityA = null;
	}
