...
@Entity(name="entity_flowgraph_activity")
public class ActivityDB extends PanacheEntity {
	...
	@javax.persistence.OneToMany(mappedBy="target_Activity")
	...
	@javax.persistence.OneToMany(mappedBy="source_Activity")
