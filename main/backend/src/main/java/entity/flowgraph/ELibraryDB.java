...
@Entity(name="entity_flowgraph_elibrary")
public class ELibraryDB extends PanacheEntity {
	...
	@javax.persistence.OneToMany(mappedBy="target_ELibrary")
	...
	@javax.persistence.OneToMany(mappedBy="source_ELibrary")
	public java.util.Collection<entity.flowgraph.LabeledTransitionDB> outgoing_LabeledTransition = new java.util.ArrayList<>();
	
	@javax.persistence.ManyToOne
	public entity.externallibrary.ExternalActivityLibraryDB library_ExternalActivityLibrary;
	...
	public PanacheEntity getLibrary() {
		if(library_ExternalActivityLibrary != null) {
			return library_ExternalActivityLibrary;
		}
		return null;
	}
	
	public void setLibrary(PanacheEntity e) {
		setLibrary(e, false);
	}
	
	public void setLibrary(PanacheEntity e, boolean deleteOld) {
		// potencially delete all old elements
		if(deleteOld) {
			if(library_ExternalActivityLibrary != null) {
				library_ExternalActivityLibrary.delete();
			}
		}
		...
		if(e instanceof entity.externallibrary.ExternalActivityLibraryDB) {
			// null all other types
			// set element
			library_ExternalActivityLibrary = (entity.externallibrary.ExternalActivityLibraryDB) e;
			return;
		}
		
		// default-case
		// null all types
		library_ExternalActivityLibrary = null;
	}
