...
@Entity(name="entity_flowgraph_transition")
public class TransitionDB extends PanacheEntity {
	
	@javax.persistence.ManyToOne
	public entity.flowgraph.FlowGraphDB container_FlowGraph;
	
	@javax.persistence.ManyToOne
	public entity.flowgraph.StartDB source_Start;
	...
	public void setSource(PanacheEntity e, boolean deleteOld) {
		...
		if(deleteOld) {
			// if no element to delete or the element to delete is
			// same that will be set then dont delete
			if(source_Start != null && !source_Start.equals(e)) {
				source_Start.delete();
			}
		}
		...
		if(e instanceof entity.flowgraph.StartDB) {
			// null all other types
			// set element
			source_Start = (entity.flowgraph.StartDB) e;
			return;
		}
	...
	public void delete() {
		...
		if(dbSource instanceof entity.flowgraph.StartDB) {
			entity.flowgraph.StartDB source = (entity.flowgraph.StartDB) dbSource;
