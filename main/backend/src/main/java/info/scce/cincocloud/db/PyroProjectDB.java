...
public class PyroProjectDB extends PanacheEntity {
    ...
    /**
     * The image that has been generated from the project.
     * If null, no image has been generated from the project yet.
    ...
    /**
     * The image that was used to create the project.
     * If the property is null, it means we use the theia language editor.
     * If the property is not null, it means we use the pyro model editor.
     * {@see #type} should be PyroProjectTypeDB.MODEL_EDITOR.
     */
    @OneToOne
