...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hierarchy.rest.ContA")
public class ContA extends ContB
{
	private String ofContA;
	
	@com.fasterxml.jackson.annotation.JsonProperty("c_ofContA")
	public String getofContA() {
	    return this.ofContA;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("ofContA")
	public void setofContA(final String ofContA) {
	    this.ofContA = ofContA;
	}
	...
	public static ContA fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.ContADB) {
			entity.hierarchy.ContADB entity = (entity.hierarchy.ContADB) dbEntity;
	...
	public static ContA fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.ContADB) {
			entity.hierarchy.ContADB entity = (entity.hierarchy.ContADB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
