...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToNode")
public class PrimeToNode implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static PrimeToNode fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToNodeDB) {
			entity.primerefs.PrimeToNodeDB entity = (entity.primerefs.PrimeToNodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToNode result;
			result = new PrimeToNode();
			if(objectCache!=null) {
	...
	public static PrimeToNode fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToNodeDB) {
			entity.primerefs.PrimeToNodeDB entity = (entity.primerefs.PrimeToNodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
