...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hooksandactions.rest.HookAContainer")
public class HookAContainer implements info.scce.pyro.core.graphmodel.Container
{
	...
	public static HookAContainer fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hooksandactions.HookAContainerDB) {
			entity.hooksandactions.HookAContainerDB entity = (entity.hooksandactions.HookAContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final HookAContainer result;
			result = new HookAContainer();
			if(objectCache!=null) {
	...
	public static HookAContainer fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hooksandactions.HookAContainerDB) {
			entity.hooksandactions.HookAContainerDB entity = (entity.hooksandactions.HookAContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
