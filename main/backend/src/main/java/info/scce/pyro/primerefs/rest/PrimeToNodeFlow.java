...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToNodeFlow")
public class PrimeToNodeFlow implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static PrimeToNodeFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToNodeFlowDB) {
			entity.primerefs.PrimeToNodeFlowDB entity = (entity.primerefs.PrimeToNodeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToNodeFlow result;
			result = new PrimeToNodeFlow();
			if(objectCache!=null) {
	...
	public static PrimeToNodeFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToNodeFlowDB) {
			entity.primerefs.PrimeToNodeFlowDB entity = (entity.primerefs.PrimeToNodeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
