...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hierarchy.rest.ContD")
public class ContD implements info.scce.pyro.core.graphmodel.Container
{
	private String ofContD;
	
	@com.fasterxml.jackson.annotation.JsonProperty("c_ofContD")
	public String getofContD() {
	    return this.ofContD;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("ofContD")
	public void setofContD(final String ofContD) {
	    this.ofContD = ofContD;
	}
	...
	public static ContD fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.ContDDB) {
			entity.hierarchy.ContDDB entity = (entity.hierarchy.ContDDB) dbEntity;
		...
		else if(dbEntity instanceof entity.hierarchy.ContADB) {
	...
	public static ContD fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.ContDDB) {
			entity.hierarchy.ContDDB entity = (entity.hierarchy.ContDDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
