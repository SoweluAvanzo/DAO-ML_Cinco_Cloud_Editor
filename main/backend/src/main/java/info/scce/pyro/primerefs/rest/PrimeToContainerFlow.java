...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToContainerFlow")
public class PrimeToContainerFlow implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static PrimeToContainerFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToContainerFlowDB) {
			entity.primerefs.PrimeToContainerFlowDB entity = (entity.primerefs.PrimeToContainerFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToContainerFlow result;
			result = new PrimeToContainerFlow();
			if(objectCache!=null) {
	...
	public static PrimeToContainerFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToContainerFlowDB) {
			entity.primerefs.PrimeToContainerFlowDB entity = (entity.primerefs.PrimeToContainerFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
