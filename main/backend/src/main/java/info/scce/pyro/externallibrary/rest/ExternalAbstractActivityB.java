...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.externallibrary.rest.ExternalAbstractActivityB")
public class ExternalAbstractActivityB extends info.scce.pyro.externallibrary.rest.ExternalAbstractActivityC 
{
	...
	public static ExternalAbstractActivityB fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache o) {
	...
	public static ExternalAbstractActivityB fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
