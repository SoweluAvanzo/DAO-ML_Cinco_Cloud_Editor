...
public class GraphModelProperty extends info.scce.pyro.rest.RESTBaseImpl
{
	...
	public static GraphModelProperty fromEntity(final entity.empty.EmptyDB entity) {
	...
	public static GraphModelProperty fromEntity(final entity.primerefs.PrimeRefsDB entity) {
	...
	public static GraphModelProperty fromEntity(final entity.hierarchy.HierarchyDB entity) {
	...
	public static GraphModelProperty fromEntity(final entity.hooksandactions.HooksAndActionsDB entity) {
	...
	public static GraphModelProperty fromEntity(final entity.flowgraph.FlowGraphDB entity) {
