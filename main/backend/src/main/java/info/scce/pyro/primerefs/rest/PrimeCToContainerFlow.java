...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeCToContainerFlow")
public class PrimeCToContainerFlow implements info.scce.pyro.core.graphmodel.Container
{
	...
	protected info.scce.pyro.flowgraph.rest.Swimlane pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.flowgraph.rest.Swimlane getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.flowgraph.rest.Swimlane pr) {
	    this.pr = pr;
	}
	...
	public static PrimeCToContainerFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToContainerFlowDB) {
			entity.primerefs.PrimeCToContainerFlowDB entity = (entity.primerefs.PrimeCToContainerFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeCToContainerFlow result;
			result = new PrimeCToContainerFlow();
			if(objectCache!=null) {
			...
			result.setpr(
				info.scce.pyro.flowgraph.rest.Swimlane.fromEntity(
	...
	public static PrimeCToContainerFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToContainerFlowDB) {
			entity.primerefs.PrimeCToContainerFlowDB entity = (entity.primerefs.PrimeCToContainerFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
