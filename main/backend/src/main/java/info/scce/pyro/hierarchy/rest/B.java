...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hierarchy.rest.B")
public abstract class B extends C
{
	...
	public static B fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
	...
	public static B fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.ADB) {
