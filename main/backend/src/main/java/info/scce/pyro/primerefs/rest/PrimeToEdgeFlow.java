...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToEdgeFlow")
public class PrimeToEdgeFlow implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static PrimeToEdgeFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToEdgeFlowDB) {
			entity.primerefs.PrimeToEdgeFlowDB entity = (entity.primerefs.PrimeToEdgeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToEdgeFlow result;
			result = new PrimeToEdgeFlow();
			if(objectCache!=null) {
	...
	public static PrimeToEdgeFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToEdgeFlowDB) {
			entity.primerefs.PrimeToEdgeFlowDB entity = (entity.primerefs.PrimeToEdgeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
