...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeCToNode")
public class PrimeCToNode implements info.scce.pyro.core.graphmodel.Container
{
	...
	protected info.scce.pyro.primerefs.rest.SourceNode pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.primerefs.rest.SourceNode getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.primerefs.rest.SourceNode pr) {
	    this.pr = pr;
	}
	...
	public static PrimeCToNode fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToNodeDB) {
			entity.primerefs.PrimeCToNodeDB entity = (entity.primerefs.PrimeCToNodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeCToNode result;
			result = new PrimeCToNode();
			if(objectCache!=null) {
	...
	public static PrimeCToNode fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToNodeDB) {
			entity.primerefs.PrimeCToNodeDB entity = (entity.primerefs.PrimeCToNodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
