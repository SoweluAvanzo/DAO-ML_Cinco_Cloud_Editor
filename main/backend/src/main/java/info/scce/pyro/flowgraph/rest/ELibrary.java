...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.ELibrary")
public class ELibrary implements info.scce.pyro.core.graphmodel.Node
{
	...
	protected info.scce.pyro.externallibrary.rest.ExternalActivityLibrary library;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_library")
	public info.scce.pyro.externallibrary.rest.ExternalActivityLibrary getlibrary() {
	    return this.library;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("library")
	public void setlibrary(final info.scce.pyro.externallibrary.rest.ExternalActivityLibrary library) {
	...
	public static ELibrary fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.ELibraryDB) {
			entity.flowgraph.ELibraryDB entity = (entity.flowgraph.ELibraryDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final ELibrary result;
			result = new ELibrary();
			if(objectCache!=null) {
	...
	public static ELibrary fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.ELibraryDB) {
			entity.flowgraph.ELibraryDB entity = (entity.flowgraph.ELibraryDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
