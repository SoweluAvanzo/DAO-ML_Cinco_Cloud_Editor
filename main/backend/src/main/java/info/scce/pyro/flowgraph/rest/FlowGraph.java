...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.FlowGraph")
public class FlowGraph implements info.scce.pyro.core.graphmodel.GraphModel, info.scce.pyro.core.rest.types.IPyroFile
{
	...
	public static FlowGraph fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.FlowGraphDB) {
			entity.flowgraph.FlowGraphDB entity = (entity.flowgraph.FlowGraphDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final FlowGraph result;
	...
	public static FlowGraph fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.FlowGraphDB) {
			entity.flowgraph.FlowGraphDB entity = (entity.flowgraph.FlowGraphDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
