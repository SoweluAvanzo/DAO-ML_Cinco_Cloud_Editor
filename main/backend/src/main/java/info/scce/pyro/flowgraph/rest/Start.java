...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.Start")
public class Start implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static Start fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.StartDB) {
			entity.flowgraph.StartDB entity = (entity.flowgraph.StartDB) dbEntity;
	...
	public static Start fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.StartDB) {
			entity.flowgraph.StartDB entity = (entity.flowgraph.StartDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
