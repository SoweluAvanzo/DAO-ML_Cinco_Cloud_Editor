...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToGraphModelFlow")
public class PrimeToGraphModelFlow implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static PrimeToGraphModelFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToGraphModelFlowDB) {
			entity.primerefs.PrimeToGraphModelFlowDB entity = (entity.primerefs.PrimeToGraphModelFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToGraphModelFlow result;
			result = new PrimeToGraphModelFlow();
			if(objectCache!=null) {
	...
	public static PrimeToGraphModelFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToGraphModelFlowDB) {
			entity.primerefs.PrimeToGraphModelFlowDB entity = (entity.primerefs.PrimeToGraphModelFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
