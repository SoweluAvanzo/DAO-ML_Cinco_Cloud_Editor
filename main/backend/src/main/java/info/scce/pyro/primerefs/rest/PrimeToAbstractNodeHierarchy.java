...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToAbstractNodeHierarchy")
public class PrimeToAbstractNodeHierarchy implements info.scce.pyro.core.graphmodel.Node
{
	...
	protected info.scce.pyro.hierarchy.rest.C pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.hierarchy.rest.C getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.hierarchy.rest.C pr) {
	    this.pr = pr;
	}
	...
	public static PrimeToAbstractNodeHierarchy fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToAbstractNodeHierarchyDB) {
			entity.primerefs.PrimeToAbstractNodeHierarchyDB entity = (entity.primerefs.PrimeToAbstractNodeHierarchyDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToAbstractNodeHierarchy result;
			result = new PrimeToAbstractNodeHierarchy();
			if(objectCache!=null) {
			...
			result.setpr(
				info.scce.pyro.hierarchy.rest.C.fromEntity(
	...
	public static PrimeToAbstractNodeHierarchy fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToAbstractNodeHierarchyDB) {
			entity.primerefs.PrimeToAbstractNodeHierarchyDB entity = (entity.primerefs.PrimeToAbstractNodeHierarchyDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
