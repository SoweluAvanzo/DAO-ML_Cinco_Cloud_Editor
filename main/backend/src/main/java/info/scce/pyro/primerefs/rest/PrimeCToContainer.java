...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeCToContainer")
public class PrimeCToContainer implements info.scce.pyro.core.graphmodel.Container
{
	...
	protected info.scce.pyro.primerefs.rest.SourceContainer pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.primerefs.rest.SourceContainer getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.primerefs.rest.SourceContainer pr) {
	    this.pr = pr;
	}
	...
	public static PrimeCToContainer fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToContainerDB) {
			entity.primerefs.PrimeCToContainerDB entity = (entity.primerefs.PrimeCToContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeCToContainer result;
			result = new PrimeCToContainer();
			if(objectCache!=null) {
	...
	public static PrimeCToContainer fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToContainerDB) {
			entity.primerefs.PrimeCToContainerDB entity = (entity.primerefs.PrimeCToContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
