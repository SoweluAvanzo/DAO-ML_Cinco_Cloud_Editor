...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hooksandactions.rest.HookANode")
public class HookANode extends AbstractHookANode
{
	...
	public static HookANode fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hooksandactions.HookANodeDB) {
			entity.hooksandactions.HookANodeDB entity = (entity.hooksandactions.HookANodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final HookANode result;
			result = new HookANode();
			if(objectCache!=null) {
	...
	public static HookANode fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hooksandactions.HookANodeDB) {
			entity.hooksandactions.HookANodeDB entity = (entity.hooksandactions.HookANodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
