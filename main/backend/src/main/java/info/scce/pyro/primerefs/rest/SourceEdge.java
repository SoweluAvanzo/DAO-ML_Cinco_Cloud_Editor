...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.SourceEdge")
public class SourceEdge implements info.scce.pyro.core.graphmodel.Edge
{
	...
	public static SourceEdge fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.SourceEdgeDB) {
			entity.primerefs.SourceEdgeDB entity = (entity.primerefs.SourceEdgeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final SourceEdge result;
			result = new SourceEdge();
			if(objectCache!=null) {
	...
	public static SourceEdge fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.SourceEdgeDB) {
			entity.primerefs.SourceEdgeDB entity = (entity.primerefs.SourceEdgeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
