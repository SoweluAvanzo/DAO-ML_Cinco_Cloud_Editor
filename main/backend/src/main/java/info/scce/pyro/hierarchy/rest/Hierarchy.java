...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hierarchy.rest.Hierarchy")
public class Hierarchy implements info.scce.pyro.core.graphmodel.GraphModel, info.scce.pyro.core.rest.types.IPyroFile
{
	private TA ta;
	...
	public static Hierarchy fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.HierarchyDB) {
			entity.hierarchy.HierarchyDB entity = (entity.hierarchy.HierarchyDB) dbEntity;
	...
	public static Hierarchy fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.HierarchyDB) {
			entity.hierarchy.HierarchyDB entity = (entity.hierarchy.HierarchyDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
