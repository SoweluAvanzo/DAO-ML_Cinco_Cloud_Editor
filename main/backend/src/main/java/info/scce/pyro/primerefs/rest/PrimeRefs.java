...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeRefs")
public class PrimeRefs implements info.scce.pyro.core.graphmodel.GraphModel, info.scce.pyro.core.rest.types.IPyroFile
{
	...
	public static PrimeRefs fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeRefsDB) {
			entity.primerefs.PrimeRefsDB entity = (entity.primerefs.PrimeRefsDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeRefs result;
			result = new PrimeRefs();
			if(objectCache!=null) {
	...
	public static PrimeRefs fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeRefsDB) {
			entity.primerefs.PrimeRefsDB entity = (entity.primerefs.PrimeRefsDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
