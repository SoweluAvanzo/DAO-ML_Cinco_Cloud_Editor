...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeCToEdgeFlow")
public class PrimeCToEdgeFlow implements info.scce.pyro.core.graphmodel.Container
{
	...
	protected info.scce.pyro.flowgraph.rest.LabeledTransition pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.flowgraph.rest.LabeledTransition getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.flowgraph.rest.LabeledTransition pr) {
	    this.pr = pr;
	}
	...
	public static PrimeCToEdgeFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToEdgeFlowDB) {
			entity.primerefs.PrimeCToEdgeFlowDB entity = (entity.primerefs.PrimeCToEdgeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeCToEdgeFlow result;
			result = new PrimeCToEdgeFlow();
			if(objectCache!=null) {
			...
			result.setpr(
				info.scce.pyro.flowgraph.rest.LabeledTransition.fromEntity(
	...
	public static PrimeCToEdgeFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToEdgeFlowDB) {
			entity.primerefs.PrimeCToEdgeFlowDB entity = (entity.primerefs.PrimeCToEdgeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
