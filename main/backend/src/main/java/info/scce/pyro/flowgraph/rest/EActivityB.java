...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.EActivityB")
public class EActivityB implements info.scce.pyro.core.graphmodel.Node
{
	...
	protected info.scce.pyro.externallibrary.rest.ExternalActivityD activityD;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_activityD")
	public info.scce.pyro.externallibrary.rest.ExternalActivityD getactivityD() {
	    return this.activityD;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("activityD")
	public void setactivityD(final info.scce.pyro.externallibrary.rest.ExternalActivityD activityD) {
	...
	public static EActivityB fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.EActivityBDB) {
			entity.flowgraph.EActivityBDB entity = (entity.flowgraph.EActivityBDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final EActivityB result;
			result = new EActivityB();
			if(objectCache!=null) {
			...
			result.setactivityD(
				info.scce.pyro.externallibrary.rest.ExternalActivityD.fromEntity(
					entity.getActivityD(), objectCache
				)
			);
	...
	public static EActivityB fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.EActivityBDB) {
			entity.flowgraph.EActivityBDB entity = (entity.flowgraph.EActivityBDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
