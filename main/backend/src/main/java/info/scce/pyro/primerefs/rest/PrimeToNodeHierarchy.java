...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToNodeHierarchy")
public class PrimeToNodeHierarchy implements info.scce.pyro.core.graphmodel.Node
{
	...
	protected info.scce.pyro.hierarchy.rest.D pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.hierarchy.rest.D getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.hierarchy.rest.D pr) {
	    this.pr = pr;
	}
	...
	public static PrimeToNodeHierarchy fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToNodeHierarchyDB) {
			entity.primerefs.PrimeToNodeHierarchyDB entity = (entity.primerefs.PrimeToNodeHierarchyDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToNodeHierarchy result;
			result = new PrimeToNodeHierarchy();
			if(objectCache!=null) {
			...
			result.setpr(
				info.scce.pyro.hierarchy.rest.D.fromEntity(
	...
	public static PrimeToNodeHierarchy fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToNodeHierarchyDB) {
			entity.primerefs.PrimeToNodeHierarchyDB entity = (entity.primerefs.PrimeToNodeHierarchyDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
