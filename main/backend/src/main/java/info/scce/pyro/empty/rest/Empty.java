package info.scce.pyro.empty.rest;
...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.empty.rest.Empty")
public class Empty implements info.scce.pyro.core.graphmodel.GraphModel, info.scce.pyro.core.rest.types.IPyroFile
{
	...
	public static Empty fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.empty.EmptyDB) {
			entity.empty.EmptyDB entity = (entity.empty.EmptyDB) dbEntity;
	...
	public static Empty fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.empty.EmptyDB) {
			entity.empty.EmptyDB entity = (entity.empty.EmptyDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
