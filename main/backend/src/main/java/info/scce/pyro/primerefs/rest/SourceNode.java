...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.SourceNode")
public class SourceNode implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static SourceNode fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.SourceNodeDB) {
			entity.primerefs.SourceNodeDB entity = (entity.primerefs.SourceNodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final SourceNode result;
	...
	public static SourceNode fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.SourceNodeDB) {
			entity.primerefs.SourceNodeDB entity = (entity.primerefs.SourceNodeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
