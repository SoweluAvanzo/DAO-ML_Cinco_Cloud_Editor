...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeCToGraphModelFlow")
public class PrimeCToGraphModelFlow implements info.scce.pyro.core.graphmodel.Container
{
	...
	protected info.scce.pyro.flowgraph.rest.FlowGraph pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.flowgraph.rest.FlowGraph getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.flowgraph.rest.FlowGraph pr) {
	    this.pr = pr;
	}
	...
	public static PrimeCToGraphModelFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToGraphModelFlowDB) {
			entity.primerefs.PrimeCToGraphModelFlowDB entity = (entity.primerefs.PrimeCToGraphModelFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeCToGraphModelFlow result;
			result = new PrimeCToGraphModelFlow();
			if(objectCache!=null) {
			...
			result.setpr(
				info.scce.pyro.flowgraph.rest.FlowGraph.fromEntity(
	...
	public static PrimeCToGraphModelFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToGraphModelFlowDB) {
			entity.primerefs.PrimeCToGraphModelFlowDB entity = (entity.primerefs.PrimeCToGraphModelFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
