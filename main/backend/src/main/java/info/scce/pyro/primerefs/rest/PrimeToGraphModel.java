...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToGraphModel")
public class PrimeToGraphModel implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static PrimeToGraphModel fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToGraphModelDB) {
			entity.primerefs.PrimeToGraphModelDB entity = (entity.primerefs.PrimeToGraphModelDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToGraphModel result;
			result = new PrimeToGraphModel();
			if(objectCache!=null) {
	...
	public static PrimeToGraphModel fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToGraphModelDB) {
			entity.primerefs.PrimeToGraphModelDB entity = (entity.primerefs.PrimeToGraphModelDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
