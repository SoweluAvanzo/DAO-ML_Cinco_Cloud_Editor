...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.SourceContainer")
public class SourceContainer implements info.scce.pyro.core.graphmodel.Container
{
	...
	public static SourceContainer fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.SourceContainerDB) {
			entity.primerefs.SourceContainerDB entity = (entity.primerefs.SourceContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final SourceContainer result;
			result = new SourceContainer();
			if(objectCache!=null) {
	...
	public static SourceContainer fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.SourceContainerDB) {
			entity.primerefs.SourceContainerDB entity = (entity.primerefs.SourceContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
