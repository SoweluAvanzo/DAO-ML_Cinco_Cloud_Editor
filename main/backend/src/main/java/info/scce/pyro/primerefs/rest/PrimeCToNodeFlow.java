...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeCToNodeFlow")
public class PrimeCToNodeFlow implements info.scce.pyro.core.graphmodel.Container
{
	...
	protected info.scce.pyro.flowgraph.rest.Activity pr;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_pr")
	public info.scce.pyro.flowgraph.rest.Activity getpr() {
	    return this.pr;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("pr")
	public void setpr(final info.scce.pyro.flowgraph.rest.Activity pr) {
	    this.pr = pr;
	}
	...
	public static PrimeCToNodeFlow fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToNodeFlowDB) {
			entity.primerefs.PrimeCToNodeFlowDB entity = (entity.primerefs.PrimeCToNodeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeCToNodeFlow result;
			result = new PrimeCToNodeFlow();
			if(objectCache!=null) {
			...
			result.setpr(
				info.scce.pyro.flowgraph.rest.Activity.fromEntity(
	...
	public static PrimeCToNodeFlow fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToNodeFlowDB) {
			entity.primerefs.PrimeCToNodeFlowDB entity = (entity.primerefs.PrimeCToNodeFlowDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
