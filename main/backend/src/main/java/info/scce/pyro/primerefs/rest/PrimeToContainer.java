...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeToContainer")
public class PrimeToContainer implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static PrimeToContainer fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToContainerDB) {
			entity.primerefs.PrimeToContainerDB entity = (entity.primerefs.PrimeToContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeToContainer result;
			result = new PrimeToContainer();
			if(objectCache!=null) {
	...
	public static PrimeToContainer fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeToContainerDB) {
			entity.primerefs.PrimeToContainerDB entity = (entity.primerefs.PrimeToContainerDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
