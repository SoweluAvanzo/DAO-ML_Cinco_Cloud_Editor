...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hierarchy.rest.C")
public abstract class C extends D
{
	...
	public static C fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
	...
	public static C fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hierarchy.ADB) {
