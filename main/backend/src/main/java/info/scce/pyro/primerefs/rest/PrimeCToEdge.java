...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.primerefs.rest.PrimeCToEdge")
public class PrimeCToEdge implements info.scce.pyro.core.graphmodel.Container
{
	...
	public static PrimeCToEdge fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToEdgeDB) {
			entity.primerefs.PrimeCToEdgeDB entity = (entity.primerefs.PrimeCToEdgeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final PrimeCToEdge result;
			result = new PrimeCToEdge();
			if(objectCache!=null) {
	...
	public static PrimeCToEdge fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.primerefs.PrimeCToEdgeDB) {
			entity.primerefs.PrimeCToEdgeDB entity = (entity.primerefs.PrimeCToEdgeDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
