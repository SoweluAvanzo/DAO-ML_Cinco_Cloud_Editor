...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.hooksandactions.rest.HooksAndActions")
public class HooksAndActions implements info.scce.pyro.core.graphmodel.GraphModel, info.scce.pyro.core.rest.types.IPyroFile
{
	private HookAType atype;
	
	@com.fasterxml.jackson.annotation.JsonProperty("c_atype")
	public HookAType getatype() {
	    return this.atype;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("atype")
	public void setatype(final HookAType atype) {
	    this.atype = atype;
	}
	...
	public static HooksAndActions fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hooksandactions.HooksAndActionsDB) {
			entity.hooksandactions.HooksAndActionsDB entity = (entity.hooksandactions.HooksAndActionsDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final HooksAndActions result;
			result = new HooksAndActions();
			if(objectCache!=null) {
			...
			PanacheEntity dbAtype = entity.getAtype();
			HookAType restAtype = (info.scce.pyro.hooksandactions.rest.HookAType) TypeRegistry.getDBToRest(dbAtype, objectCache, false);
			result.setatype(restAtype);	
	...
	public static HooksAndActions fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.hooksandactions.HooksAndActionsDB) {
			entity.hooksandactions.HooksAndActionsDB entity = (entity.hooksandactions.HooksAndActionsDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			...
			//additional attributes
			PanacheEntity dbAtype = entity.getAtype();
			HookAType restAtype = (info.scce.pyro.hooksandactions.rest.HookAType) TypeRegistry.getDBToRest(dbAtype, objectCache, true);
			result.setatype(restAtype);	
