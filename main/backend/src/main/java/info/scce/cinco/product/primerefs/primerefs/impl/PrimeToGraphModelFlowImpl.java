...
public class PrimeToGraphModelFlowImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToGraphModelFlow {
	
	private final entity.primerefs.PrimeToGraphModelFlowDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToGraphModelFlowImpl(
		entity.primerefs.PrimeToGraphModelFlowDB delegate,
	...
	public PrimeToGraphModelFlowImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToGraphModelFlowDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToGraphModelFlow
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToGraphModelFlow) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToGraphModelFlowDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToGraphModelFlow(this,this.getPr());
