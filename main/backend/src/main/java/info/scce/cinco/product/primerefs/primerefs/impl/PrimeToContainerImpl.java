...
public class PrimeToContainerImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToContainer {
	
	private final entity.primerefs.PrimeToContainerDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToContainerImpl(
		entity.primerefs.PrimeToContainerDB delegate,
	...
	public PrimeToContainerImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToContainerDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToContainer
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToContainer) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToContainerDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToContainer(this,this.getPr());
