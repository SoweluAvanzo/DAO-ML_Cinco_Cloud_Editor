...
public class PrimeToNodeFlowImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToNodeFlow {
	
	private final entity.primerefs.PrimeToNodeFlowDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToNodeFlowImpl(
		entity.primerefs.PrimeToNodeFlowDB delegate,
	...
	public PrimeToNodeFlowImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToNodeFlowDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToNodeFlow
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToNodeFlow) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToNodeFlowDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToNodeFlow(this,this.getPr());
