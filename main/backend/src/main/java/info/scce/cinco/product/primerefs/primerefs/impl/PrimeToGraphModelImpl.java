...
public class PrimeToGraphModelImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToGraphModel {
	
	private final entity.primerefs.PrimeToGraphModelDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToGraphModelImpl(
		entity.primerefs.PrimeToGraphModelDB delegate,
	...
	public PrimeToGraphModelImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToGraphModelDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToGraphModel
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToGraphModel) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToGraphModelDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToGraphModel(this,this.getPr());
