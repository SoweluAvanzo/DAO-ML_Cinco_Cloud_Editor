...
public class PrimeCToNodeFlowImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeCToNodeFlow {
	
	private final entity.primerefs.PrimeCToNodeFlowDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeCToNodeFlowImpl(
		entity.primerefs.PrimeCToNodeFlowDB delegate,
	...
	public PrimeCToNodeFlowImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeCToNodeFlowDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeCToNodeFlow
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeCToNodeFlow) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeCToNodeFlowDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removePrimeCToNodeFlow(this,this.getPr());
	...
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Activity getPr()
	{
		PanacheEntity entity = delegate.getPr();
		return (info.scce.cinco.product.flowgraph.flowgraph.Activity) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
