...
public class SourceContainerImpl implements info.scce.cinco.product.primerefs.primerefs.SourceContainer {
	
	private final entity.primerefs.SourceContainerDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public SourceContainerImpl(
		entity.primerefs.SourceContainerDB delegate,
	...
	public SourceContainerImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.SourceContainerDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.SourceContainer
			&& ((info.scce.cinco.product.primerefs.primerefs.SourceContainer) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.SourceContainerDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removeSourceContainer(this);
