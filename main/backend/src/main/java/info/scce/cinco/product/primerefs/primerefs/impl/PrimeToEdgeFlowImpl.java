...
public class PrimeToEdgeFlowImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToEdgeFlow {
	
	private final entity.primerefs.PrimeToEdgeFlowDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToEdgeFlowImpl(
		entity.primerefs.PrimeToEdgeFlowDB delegate,
	...
	public PrimeToEdgeFlowImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToEdgeFlowDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToEdgeFlow
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToEdgeFlow) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToEdgeFlowDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToEdgeFlow(this,this.getPr());
