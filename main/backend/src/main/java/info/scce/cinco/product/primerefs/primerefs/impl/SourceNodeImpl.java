...
public class SourceNodeImpl implements info.scce.cinco.product.primerefs.primerefs.SourceNode {
	
	private final entity.primerefs.SourceNodeDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public SourceNodeImpl(
		entity.primerefs.SourceNodeDB delegate,
	...
	public SourceNodeImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.SourceNodeDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.SourceNode
			&& ((info.scce.cinco.product.primerefs.primerefs.SourceNode) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.SourceNodeDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removeSourceNode(this);
