...
public class EActivityAImpl implements info.scce.cinco.product.flowgraph.flowgraph.EActivityA {
	
	private final entity.flowgraph.EActivityADB delegate;
	private final FlowGraphCommandExecuter cmdExecuter;

	public EActivityAImpl(
		entity.flowgraph.EActivityADB delegate,
	...
	public EActivityAImpl(
		FlowGraphCommandExecuter cmdExecuter	) {
		this.delegate = new entity.flowgraph.EActivityADB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.flowgraph.flowgraph.EActivityA
			&& ((info.scce.cinco.product.flowgraph.flowgraph.EActivityA) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.flowgraph.EActivityADB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removeEActivityA(this,this.getActivityC());
	...
	@Override
	public externallibrary.ExternalAbstractActivityC getActivityC()
	{
		PanacheEntity entity = delegate.getActivityC();
		return (externallibrary.ExternalAbstractActivityC) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
