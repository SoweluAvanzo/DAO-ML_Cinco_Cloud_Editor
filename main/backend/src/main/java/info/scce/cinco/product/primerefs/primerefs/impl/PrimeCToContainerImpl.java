...
public class PrimeCToContainerImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeCToContainer {
	
	private final entity.primerefs.PrimeCToContainerDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeCToContainerImpl(
		entity.primerefs.PrimeCToContainerDB delegate,
	...
	public PrimeCToContainerImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeCToContainerDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeCToContainer
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeCToContainer) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeCToContainerDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removePrimeCToContainer(this,this.getPr());
	...
	@Override
	public info.scce.cinco.product.primerefs.primerefs.SourceContainer getPr()
	{
		PanacheEntity entity = delegate.getPr();
		return (info.scce.cinco.product.primerefs.primerefs.SourceContainer) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
