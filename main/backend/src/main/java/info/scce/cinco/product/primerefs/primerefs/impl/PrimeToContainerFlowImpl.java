...
public class PrimeToContainerFlowImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToContainerFlow {
	
	private final entity.primerefs.PrimeToContainerFlowDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToContainerFlowImpl(
		entity.primerefs.PrimeToContainerFlowDB delegate,
	...
	public PrimeToContainerFlowImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToContainerFlowDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToContainerFlow
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToContainerFlow) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToContainerFlowDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToContainerFlow(this,this.getPr());
