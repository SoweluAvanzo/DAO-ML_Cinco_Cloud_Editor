...
public class PrimeCToNodeImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeCToNode {
	
	private final entity.primerefs.PrimeCToNodeDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeCToNodeImpl(
		entity.primerefs.PrimeCToNodeDB delegate,
	...
	public PrimeCToNodeImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeCToNodeDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeCToNode
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeCToNode) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeCToNodeDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removePrimeCToNode(this,this.getPr());
