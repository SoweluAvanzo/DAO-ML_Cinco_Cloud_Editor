...
public class PrimeCToGraphModelImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeCToGraphModel {
	
	private final entity.primerefs.PrimeCToGraphModelDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeCToGraphModelImpl(
		entity.primerefs.PrimeCToGraphModelDB delegate,
	...
	public PrimeCToGraphModelImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeCToGraphModelDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeCToGraphModel
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeCToGraphModel) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeCToGraphModelDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removePrimeCToGraphModel(this,this.getPr());
	...
	@Override
	public info.scce.cinco.product.primerefs.primerefs.PrimeRefs getPr()
	{
		PanacheEntity entity = delegate.getPr();
		return (info.scce.cinco.product.primerefs.primerefs.PrimeRefs) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
