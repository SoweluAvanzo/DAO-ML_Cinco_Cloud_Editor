...
public class PrimeCToGraphModelFlowImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeCToGraphModelFlow {
	
	private final entity.primerefs.PrimeCToGraphModelFlowDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeCToGraphModelFlowImpl(
		entity.primerefs.PrimeCToGraphModelFlowDB delegate,
	...
	public PrimeCToGraphModelFlowImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeCToGraphModelFlowDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeCToGraphModelFlow
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeCToGraphModelFlow) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeCToGraphModelFlowDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removePrimeCToGraphModelFlow(this,this.getPr());
