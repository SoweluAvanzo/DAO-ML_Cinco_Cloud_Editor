...
public class ContAImpl implements info.scce.cinco.product.hierarchy.hierarchy.ContA {
	
	private final entity.hierarchy.ContADB delegate;
	private final HierarchyCommandExecuter cmdExecuter;

	public ContAImpl(
		entity.hierarchy.ContADB delegate,
	...
	public ContAImpl(
		HierarchyCommandExecuter cmdExecuter	) {
		this.delegate = new entity.hierarchy.ContADB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.hierarchy.hierarchy.ContA
			&& ((info.scce.cinco.product.hierarchy.hierarchy.ContA) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.hierarchy.ContADB getDelegate() {
	...
	public void setOfContA(String attr) {
		info.scce.pyro.hierarchy.rest.ContA prev = info.scce.pyro.hierarchy.rest.ContA.fromEntityProperties(this.delegate,null);
		this.delegate.ofContA = attr;
		
		// commandExecuter
		this.cmdExecuter.updateContAProperties(this,prev);
