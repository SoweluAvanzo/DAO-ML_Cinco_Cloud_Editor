...
public class PrimeCToEdgeFlowImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeCToEdgeFlow {
	
	private final entity.primerefs.PrimeCToEdgeFlowDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeCToEdgeFlowImpl(
		entity.primerefs.PrimeCToEdgeFlowDB delegate,
	...
	public PrimeCToEdgeFlowImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeCToEdgeFlowDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeCToEdgeFlow
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeCToEdgeFlow) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeCToEdgeFlowDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removePrimeCToEdgeFlow(this,this.getPr());
	...
	public info.scce.cinco.product.flowgraph.flowgraph.LabeledTransition getPr()
	{
		...
		return (info.scce.cinco.product.flowgraph.flowgraph.LabeledTransition) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
