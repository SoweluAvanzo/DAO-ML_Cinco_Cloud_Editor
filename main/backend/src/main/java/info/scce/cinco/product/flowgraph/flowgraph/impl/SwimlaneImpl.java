...
public class SwimlaneImpl implements info.scce.cinco.product.flowgraph.flowgraph.Swimlane {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removeSwimlane(this);
	...
	public void setActor(String attr) {
		info.scce.pyro.flowgraph.rest.Swimlane prev = info.scce.pyro.flowgraph.rest.Swimlane.fromEntityProperties(this.delegate,null);
		this.delegate.actor = attr;
		
		// commandExecuter
		this.cmdExecuter.updateSwimlaneProperties(this,prev);
