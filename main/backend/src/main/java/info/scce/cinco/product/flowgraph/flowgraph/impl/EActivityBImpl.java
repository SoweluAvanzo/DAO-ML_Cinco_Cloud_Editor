...
public class EActivityBImpl implements info.scce.cinco.product.flowgraph.flowgraph.EActivityB {
	
	private final entity.flowgraph.EActivityBDB delegate;
	private final FlowGraphCommandExecuter cmdExecuter;

	public EActivityBImpl(
		entity.flowgraph.EActivityBDB delegate,
	...
	public EActivityBImpl(
		FlowGraphCommandExecuter cmdExecuter	) {
		this.delegate = new entity.flowgraph.EActivityBDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.flowgraph.flowgraph.EActivityB
			&& ((info.scce.cinco.product.flowgraph.flowgraph.EActivityB) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.flowgraph.EActivityBDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removeEActivityB(this,this.getActivityD());
	...
	{
		PanacheEntity entity = delegate.getActivityD();
		return (externallibrary.ExternalActivityD) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
