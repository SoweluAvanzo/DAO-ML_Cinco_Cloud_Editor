...
public class SubFlowGraphImpl implements info.scce.cinco.product.flowgraph.flowgraph.SubFlowGraph {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removeSubFlowGraph(this,this.getSubFlowGraph());
	...
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.FlowGraph getSubFlowGraph()
	{
		PanacheEntity entity = delegate.getSubFlowGraph();
		return (info.scce.cinco.product.flowgraph.flowgraph.FlowGraph) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
