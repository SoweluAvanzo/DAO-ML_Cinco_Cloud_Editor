...
public class PrimeToEdgeImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToEdge {
	
	private final entity.primerefs.PrimeToEdgeDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToEdgeImpl(
		entity.primerefs.PrimeToEdgeDB delegate,
	...
	public PrimeToEdgeImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToEdgeDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToEdge
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToEdge) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToEdgeDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToEdge(this,this.getPr());
