...
import info.scce.cinco.product.primerefs.primerefs.PrimeRefs;
...
public class PrimeRefsFactoryImpl implements PrimeRefsFactory {
    ...
    public static PrimeRefsFactory init() {
    	return new PrimeRefsFactoryImpl();
    }
    ...
    public PrimeRefs createPrimeRefs(String projectRelativePath, String filename)
    {
        ...
        if(folder instanceof PyroProjectDB) {
        	((PyroProjectDB)folder).files_PrimeRefs.add(newGraph);
        } else if(folder instanceof PyroFolderDB) {
        	((PyroFolderDB)folder).files_PrimeRefs.add(newGraph);
        }
        
        sendProjectUpdate();
        return new info.scce.cinco.product.primerefs.primerefs.impl.PrimeRefsImpl(newGraph,executer);
    }
