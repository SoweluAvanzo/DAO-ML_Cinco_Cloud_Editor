...
public class PrimeToNodeHierarchyImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToNodeHierarchy {
	
	private final entity.primerefs.PrimeToNodeHierarchyDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToNodeHierarchyImpl(
		entity.primerefs.PrimeToNodeHierarchyDB delegate,
	...
	public PrimeToNodeHierarchyImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToNodeHierarchyDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToNodeHierarchy
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToNodeHierarchy) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToNodeHierarchyDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToNodeHierarchy(this,this.getPr());
	...
	@Override
	public info.scce.cinco.product.hierarchy.hierarchy.D getPr()
	{
		PanacheEntity entity = delegate.getPr();
		return (info.scce.cinco.product.hierarchy.hierarchy.D) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
}
