...
public class StartImpl implements info.scce.cinco.product.flowgraph.flowgraph.Start {
	
	private final entity.flowgraph.StartDB delegate;
	private final FlowGraphCommandExecuter cmdExecuter;

	public StartImpl(
		entity.flowgraph.StartDB delegate,
	...
	public StartImpl(
		FlowGraphCommandExecuter cmdExecuter	) {
		this.delegate = new entity.flowgraph.StartDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.flowgraph.flowgraph.Start
			&& ((info.scce.cinco.product.flowgraph.flowgraph.Start) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.flowgraph.StartDB getDelegate() {
	...
	public info.scce.cinco.product.flowgraph.flowgraph.FlowGraph getRootElement() {
		...
		if(container instanceof info.scce.cinco.product.flowgraph.flowgraph.FlowGraph){
			return (info.scce.cinco.product.flowgraph.flowgraph.FlowGraph) container;
		} else if(container instanceof graphmodel.ModelElement) {
			graphmodel.ModelElement parent = (graphmodel.ModelElement) container;
			return (info.scce.cinco.product.flowgraph.flowgraph.FlowGraph) parent.getRootElement();
		} else {
			return null;
		}
	}
	...
	private void changeContainer(PanacheEntity newContainer) {
		...
		} else if(c instanceof entity.flowgraph.FlowGraphDB) {
	...
	@Override
	public java.util.List<info.scce.cinco.product.flowgraph.flowgraph.Transition> getOutgoingTransitions() {
		return getOutgoing(info.scce.cinco.product.flowgraph.flowgraph.Transition.class);
	}
				
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.End target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = cmdExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
		return cn;
	}
				
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.Activity target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = cmdExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
		return cn;
	}
				
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.EActivityA target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = cmdExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
		return cn;
	}
				
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.EActivityB target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = cmdExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
		return cn;
	}
				
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.ELibrary target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = cmdExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
		return cn;
	}
				
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.SubFlowGraph target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = cmdExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
		return cn;
	}
