...
public class PrimeToAbstractNodeHierarchyImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeToAbstractNodeHierarchy {
	
	private final entity.primerefs.PrimeToAbstractNodeHierarchyDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeToAbstractNodeHierarchyImpl(
		entity.primerefs.PrimeToAbstractNodeHierarchyDB delegate,
	...
	public PrimeToAbstractNodeHierarchyImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeToAbstractNodeHierarchyDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeToAbstractNodeHierarchy
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeToAbstractNodeHierarchy) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeToAbstractNodeHierarchyDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removePrimeToAbstractNodeHierarchy(this,this.getPr());
	...
	@Override
	public info.scce.cinco.product.hierarchy.hierarchy.C getPr()
	{
		PanacheEntity entity = delegate.getPr();
		return (info.scce.cinco.product.hierarchy.hierarchy.C) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
}
