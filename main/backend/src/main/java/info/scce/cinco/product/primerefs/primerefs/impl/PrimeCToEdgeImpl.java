...
public class PrimeCToEdgeImpl implements info.scce.cinco.product.primerefs.primerefs.PrimeCToEdge {
	
	private final entity.primerefs.PrimeCToEdgeDB delegate;
	private final PrimeRefsCommandExecuter cmdExecuter;

	public PrimeCToEdgeImpl(
		entity.primerefs.PrimeCToEdgeDB delegate,
	...
	public PrimeCToEdgeImpl(
		PrimeRefsCommandExecuter cmdExecuter	) {
		this.delegate = new entity.primerefs.PrimeCToEdgeDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.primerefs.primerefs.PrimeCToEdge
			&& ((info.scce.cinco.product.primerefs.primerefs.PrimeCToEdge) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.primerefs.PrimeCToEdgeDB getDelegate() {
	...
	public void delete() {
		removeEdges();
		removeNodes();
		cmdExecuter.removePrimeCToEdge(this,this.getPr());
	...
	public info.scce.cinco.product.primerefs.primerefs.SourceEdge getPr()
	{
		...
		return (info.scce.cinco.product.primerefs.primerefs.SourceEdge) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
