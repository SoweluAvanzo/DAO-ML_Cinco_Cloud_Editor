...
public class ActivityImpl implements info.scce.cinco.product.flowgraph.flowgraph.Activity {
	...
	public void delete() {
		removeEdges();
		cmdExecuter.removeActivity(this);
	...
	public void setName(String attr) {
		info.scce.pyro.flowgraph.rest.Activity prev = info.scce.pyro.flowgraph.rest.Activity.fromEntityProperties(this.delegate,null);
		this.delegate.name = attr;
		
		// commandExecuter
		this.cmdExecuter.updateActivityProperties(this,prev);
