...
COPY ./main/frontend/package.json /app/main/frontend
COPY ./main/frontend/package-lock.json /app/main/frontend
RUN cd ./frontend && npm install
COPY ./main/frontend /app/main/frontend
# copy backend files
...
CMD cd /app/main/frontend && npm run start & cd /app/main/backend && ./mvnw quarkus:dev \
