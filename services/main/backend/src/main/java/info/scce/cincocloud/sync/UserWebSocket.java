...
public class UserWebSocket {
  ...
  public void open(final Session session, EndpointConfig conf, @PathParam("ticket") String ticket)
      throws IOException {
  ...
  /**
   * Sends the given serialized instance of Project to all listening WebSocket connections for currentUser with the
   * given id.
   *
