...
@Entity(name="entity_flowgraph_externalactivity")
public class ExternalActivityDB extends PanacheEntity {
	...
	@javax.persistence.OneToMany(mappedBy="target_ExternalActivity")
	...
	@javax.persistence.OneToMany(mappedBy="source_ExternalActivity")
	public java.util.Collection<entity.flowgraph.LabeledTransitionDB> outgoing_LabeledTransition = new java.util.ArrayList<>();
	
	@javax.persistence.ManyToOne(cascade=javax.persistence.CascadeType.ALL)
	@javax.persistence.JoinColumn(
		nullable=true)
	public entity.externallibrary.ExternalActivityDB activity_ExternalActivity;
	...
	public PanacheEntity getActivity() {
		if(activity_ExternalActivity != null) {
			return activity_ExternalActivity;
		}
		return null;
	}
	
	public void setActivity(PanacheEntity e) {
		setActivity(e, false);
	}
	
	public void setActivity(PanacheEntity e, boolean deleteOld) {
		// potencially delete all old elements
		if(deleteOld) {
			if(activity_ExternalActivity != null) {
				activity_ExternalActivity.delete();
			}
		}
		...
		if(e instanceof entity.externallibrary.ExternalActivityDB) {
			// null all other types
			// set element
			activity_ExternalActivity = (entity.externallibrary.ExternalActivityDB) e;
			return;
		}
		
		// default-case
		// null all types
		activity_ExternalActivity = null;
	}
