...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.Swimlane")
public class Swimlane implements info.scce.pyro.core.graphmodel.Container
{
	private String actor;
	
	@com.fasterxml.jackson.annotation.JsonProperty("c_actor")
	...
	public static Swimlane fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.SwimlaneDB) {
			entity.flowgraph.SwimlaneDB entity = (entity.flowgraph.SwimlaneDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final Swimlane result;
			result = new Swimlane();
			if(objectCache!=null) {
	...
	public static Swimlane fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.SwimlaneDB) {
			entity.flowgraph.SwimlaneDB entity = (entity.flowgraph.SwimlaneDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
