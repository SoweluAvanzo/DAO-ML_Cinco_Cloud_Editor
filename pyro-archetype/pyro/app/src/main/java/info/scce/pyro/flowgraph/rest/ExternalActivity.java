...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.ExternalActivity")
public class ExternalActivity implements info.scce.pyro.core.graphmodel.Node
{
	...
	protected info.scce.pyro.externallibrary.rest.ExternalActivity activity;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_activity")
	public info.scce.pyro.externallibrary.rest.ExternalActivity getactivity() {
	    return this.activity;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("activity")
	public void setactivity(final info.scce.pyro.externallibrary.rest.ExternalActivity activity) {
	...
	public static ExternalActivity fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.ExternalActivityDB) {
			entity.flowgraph.ExternalActivityDB entity = (entity.flowgraph.ExternalActivityDB) dbEntity;
			...
			result.setactivity(
				info.scce.pyro.externallibrary.rest.ExternalActivity.fromEntityProperties(
					entity.getActivity(), objectCache
				)
			);
	...
	public static ExternalActivity fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.ExternalActivityDB) {
			entity.flowgraph.ExternalActivityDB entity = (entity.flowgraph.ExternalActivityDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
