...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.Activity")
public class Activity implements info.scce.pyro.core.graphmodel.Node
{
	private String name;
	
	@com.fasterxml.jackson.annotation.JsonProperty("c_name")
	...
	@com.fasterxml.jackson.annotation.JsonProperty("c_description")
	...
	public static Activity fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.ActivityDB) {
			entity.flowgraph.ActivityDB entity = (entity.flowgraph.ActivityDB) dbEntity;
	...
	public static Activity fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.ActivityDB) {
			entity.flowgraph.ActivityDB entity = (entity.flowgraph.ActivityDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
