...
public class ActivityImpl implements info.scce.cinco.product.flowgraph.flowgraph.Activity {
	
	private final entity.flowgraph.ActivityDB delegate;
	
	private final CommandExecuter cmdExecuter;
	
	
	public ActivityImpl(
		entity.flowgraph.ActivityDB delegate,
	...
	public ActivityImpl(
		CommandExecuter cmdExecuter	) {
		this.delegate = new entity.flowgraph.ActivityDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.flowgraph.flowgraph.Activity
			&& ((info.scce.cinco.product.flowgraph.flowgraph.Activity) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.flowgraph.ActivityDB getDelegate() {
		return this.delegate;
	}
	
	
	public info.scce.cinco.product.flowgraph.flowgraph.Activity getActivityView() {
		return this;
	}
	
	public info.scce.cinco.product.flowgraph.flowgraph.Activity eClass() {
		return this;
	}
	...
	public void delete() {
		...
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			...
			flowgraphdiagramCommandExecuter.removeActivity(this);
		}
		else
	...
	@Override
	public java.util.List<info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity> getExternalActivityPredecessors() {
		return getPredecessors(info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity.class);
	}
	...
	public info.scce.cinco.product.flowgraph.flowgraph.LabeledTransition newLabeledTransition(info.scce.cinco.product.flowgraph.flowgraph.End target) {
		info.scce.cinco.product.flowgraph.flowgraph.LabeledTransition cn = null;
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			FlowGraphDiagramCommandExecuter flowgraphdiagramCommandExecuter = (FlowGraphDiagramCommandExecuter) cmdExecuter;
			cn = flowgraphdiagramCommandExecuter.createLabeledTransition(this, target, java.util.Collections.emptyList(), null);
		}
		else
			if(cmdExecuter != null) throw new RuntimeException("GraphModelCommandExecuter can not handle this type!");
		return cn;
	...
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.LabeledTransition newLabeledTransition(info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity target) {
		info.scce.cinco.product.flowgraph.flowgraph.LabeledTransition cn = null;
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			FlowGraphDiagramCommandExecuter flowgraphdiagramCommandExecuter = (FlowGraphDiagramCommandExecuter) cmdExecuter;
			cn = flowgraphdiagramCommandExecuter.createLabeledTransition(this, target, java.util.Collections.emptyList(), null);
	...
	public void setName(String attr) {
		info.scce.pyro.flowgraph.rest.Activity prev = info.scce.pyro.flowgraph.rest.Activity.fromEntityProperties(this.delegate,new info.scce.pyro.rest.ObjectCache());
		this.delegate.name = attr;
		
		// commandExecuter
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			FlowGraphDiagramCommandExecuter flowgraphdiagramCommandExecuter = (FlowGraphDiagramCommandExecuter) cmdExecuter;
			flowgraphdiagramCommandExecuter.updateActivityProperties(this,prev);
		}
		else
			if(cmdExecuter != null) throw new RuntimeException("GraphModelCommandExecuter can not handle this type!");
	...
	@Override
	public void setDescription(String attr) {
		info.scce.pyro.flowgraph.rest.Activity prev = info.scce.pyro.flowgraph.rest.Activity.fromEntityProperties(this.delegate,new info.scce.pyro.rest.ObjectCache());
		this.delegate.description = attr;
