...
public class GraphModelController {
	...
	@javax.inject.Inject
	FlowGraphDiagramController flowgraphdiagramController;
    ...
    public Response updateGraphModel(@javax.ws.rs.core.Context SecurityContext securityContext, info.scce.pyro.core.graphmodel.GraphModel graphModel) {
        ...
        //find graphmodel
        {
            final Optional<entity.flowgraph.FlowGraphDiagramDB> opt = entity.flowgraph.FlowGraphDiagramDB.findByIdOptional(graphModel.getId());
            if(opt.isPresent()) {
                entity.flowgraph.FlowGraphDiagramDB g = opt.get();
