...
public class StartImpl implements info.scce.cinco.product.flowgraph.flowgraph.Start {
	...
	public info.scce.cinco.product.flowgraph.flowgraph.Start getStartView() {
		return this;
	}
	
	public info.scce.cinco.product.flowgraph.flowgraph.Start eClass() {
		return this;
	}
	...
	public void delete() {
		...
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			...
			flowgraphdiagramCommandExecuter.removeStart(this);
		}
		else
	...
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.End target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = null;
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			FlowGraphDiagramCommandExecuter flowgraphdiagramCommandExecuter = (FlowGraphDiagramCommandExecuter) cmdExecuter;
			cn = flowgraphdiagramCommandExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
		}
		else
			if(cmdExecuter != null) throw new RuntimeException("GraphModelCommandExecuter can not handle this type!");
		return cn;
	...
	@Override
	public info.scce.cinco.product.flowgraph.flowgraph.Transition newTransition(info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity target) {
		info.scce.cinco.product.flowgraph.flowgraph.Transition cn = null;
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			FlowGraphDiagramCommandExecuter flowgraphdiagramCommandExecuter = (FlowGraphDiagramCommandExecuter) cmdExecuter;
			cn = flowgraphdiagramCommandExecuter.createTransition(this, target, java.util.Collections.emptyList(), null);
	...
	@Override
	public java.util.List<info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity> getExternalActivitySuccessors() {
		return getSuccessors(info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity.class);
	}
