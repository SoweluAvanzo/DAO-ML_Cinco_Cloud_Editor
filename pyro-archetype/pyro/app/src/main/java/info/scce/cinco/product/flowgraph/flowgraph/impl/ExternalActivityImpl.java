...
public class ExternalActivityImpl implements info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity {
	
	private final entity.flowgraph.ExternalActivityDB delegate;
	
	private final CommandExecuter cmdExecuter;
	
	
	public ExternalActivityImpl(
		entity.flowgraph.ExternalActivityDB delegate,
	...
	public ExternalActivityImpl(
		CommandExecuter cmdExecuter	) {
		this.delegate = new entity.flowgraph.ExternalActivityDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity
			&& ((info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.flowgraph.ExternalActivityDB getDelegate() {
		return this.delegate;
	}
	
	
	public info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity getExternalActivityView() {
		return this;
	}
	
	public info.scce.cinco.product.flowgraph.flowgraph.ExternalActivity eClass() {
		return this;
	}
	...
	@Override
	public externallibrary.ExternalActivity getActivity()
	{
		PanacheEntity entity = delegate.getActivity();
		return (externallibrary.ExternalActivity) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
