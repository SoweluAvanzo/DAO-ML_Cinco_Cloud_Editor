...
public class SubFlowGraphImpl implements info.scce.cinco.product.flowgraph.flowgraph.SubFlowGraph {
	
	private final entity.flowgraph.SubFlowGraphDB delegate;
	
	private final CommandExecuter cmdExecuter;
	
	
	public SubFlowGraphImpl(
		entity.flowgraph.SubFlowGraphDB delegate,
	...
	public SubFlowGraphImpl(
		CommandExecuter cmdExecuter	) {
		this.delegate = new entity.flowgraph.SubFlowGraphDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.flowgraph.flowgraph.SubFlowGraph
			&& ((info.scce.cinco.product.flowgraph.flowgraph.SubFlowGraph) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.flowgraph.SubFlowGraphDB getDelegate() {
		return this.delegate;
	}
	
	
	public info.scce.cinco.product.flowgraph.flowgraph.SubFlowGraph getSubFlowGraphView() {
		return this;
	}
	
	public info.scce.cinco.product.flowgraph.flowgraph.SubFlowGraph eClass() {
		return this;
	}
	...
	public void delete() {
		...
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			...
			flowgraphdiagramCommandExecuter.removeSubFlowGraph(this,this.getSubFlowGraph());
		}
		else
	...
	{
		PanacheEntity entity = delegate.getSubFlowGraph();
		return (info.scce.cinco.product.flowgraph.flowgraph.FlowGraphDiagram) TypeRegistry.getDBToApi(entity, cmdExecuter);
	}
