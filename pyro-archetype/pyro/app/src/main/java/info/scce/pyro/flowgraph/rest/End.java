...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.End")
public class End implements info.scce.pyro.core.graphmodel.Node
{
	...
	public static End fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.EndDB) {
			entity.flowgraph.EndDB entity = (entity.flowgraph.EndDB) dbEntity;
	...
	public static End fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.EndDB) {
			entity.flowgraph.EndDB entity = (entity.flowgraph.EndDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
