...
public class EndImpl implements info.scce.cinco.product.flowgraph.flowgraph.End {
	
	private final entity.flowgraph.EndDB delegate;
	
	private final CommandExecuter cmdExecuter;
	
	
	public EndImpl(
		entity.flowgraph.EndDB delegate,
	...
	public EndImpl(
		CommandExecuter cmdExecuter	) {
		this.delegate = new entity.flowgraph.EndDB();
	...
	public boolean equals(Object obj) {
		return obj!=null
			&& obj instanceof info.scce.cinco.product.flowgraph.flowgraph.End
			&& ((info.scce.cinco.product.flowgraph.flowgraph.End) obj).getId().equals(getId());
	}
	...
	@Override
	public entity.flowgraph.EndDB getDelegate() {
		return this.delegate;
	}
	
	
	public info.scce.cinco.product.flowgraph.flowgraph.End getEndView() {
		return this;
	}
	
	public info.scce.cinco.product.flowgraph.flowgraph.End eClass() {
		return this;
	}
	...
	public void delete() {
		...
		if(cmdExecuter instanceof FlowGraphDiagramCommandExecuter) {
			...
			flowgraphdiagramCommandExecuter.removeEnd(this);
		}
		else
