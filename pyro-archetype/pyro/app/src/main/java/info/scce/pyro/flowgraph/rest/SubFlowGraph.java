...
@com.fasterxml.jackson.annotation.JsonTypeName("info.scce.pyro.flowgraph.rest.SubFlowGraph")
public class SubFlowGraph implements info.scce.pyro.core.graphmodel.Node
{
	...
	protected info.scce.pyro.flowgraph.rest.FlowGraphDiagram subFlowGraph;
	
	@com.fasterxml.jackson.annotation.JsonProperty("b_subFlowGraph")
	public info.scce.pyro.flowgraph.rest.FlowGraphDiagram getsubFlowGraph() {
	    return this.subFlowGraph;
	}
	
	@com.fasterxml.jackson.annotation.JsonProperty("subFlowGraph")
	public void setsubFlowGraph(final info.scce.pyro.flowgraph.rest.FlowGraphDiagram subFlowGraph) {
	...
	public static SubFlowGraph fromEntity(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.SubFlowGraphDB) {
			entity.flowgraph.SubFlowGraphDB entity = (entity.flowgraph.SubFlowGraphDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
			}
			final SubFlowGraph result;
			result = new SubFlowGraph();
			if(objectCache!=null) {
	...
	public static SubFlowGraph fromEntityProperties(final PanacheEntity dbEntity, info.scce.pyro.rest.ObjectCache objectCache) {
		if(dbEntity instanceof entity.flowgraph.SubFlowGraphDB) {
			entity.flowgraph.SubFlowGraphDB entity = (entity.flowgraph.SubFlowGraphDB) dbEntity;
			if(objectCache!=null&&objectCache.containsRestTo(entity)){
				return objectCache.getRestTo(entity);
