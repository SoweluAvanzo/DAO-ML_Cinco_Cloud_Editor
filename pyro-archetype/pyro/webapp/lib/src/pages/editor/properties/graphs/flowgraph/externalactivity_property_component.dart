...
@Component(
	selector: 'externalactivity-property',
	templateUrl: 'externalactivity_property_component.html',
	directives: const [coreDirectives,formDirectives]
)
class ExternalActivityPropertyComponent {

  @Input()
  flowgraph.ExternalActivity currentElement;
  ...
  ExternalActivityPropertyComponent() {
  }
