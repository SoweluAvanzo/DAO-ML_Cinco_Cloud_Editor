...
@Component(
	selector: 'labeledtransition-property',
	templateUrl: 'labeledtransition_property_component.html',
	directives: const [coreDirectives,formDirectives]
)
class LabeledTransitionPropertyComponent {

  @Input()
  flowgraph.LabeledTransition currentElement;
