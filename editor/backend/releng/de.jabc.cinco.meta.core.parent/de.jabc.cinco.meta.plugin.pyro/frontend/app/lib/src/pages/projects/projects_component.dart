...
class ProjectsComponent implements OnDestroy, OnInit {
  ...
  void openCurrentProject(PyroProject project) {
    ...
    _router.navigate(top_routes.RoutePaths.editor
        .toUrl(parameters: {'orgId': '$orgId', 'projectId': '$projectId'}));
  }

  void openProjectPermissions(PyroProject project) {
    var orgId = organization.id;
    var projectId = project.id;
    _router.navigate(top_routes.RoutePaths.projectPermissions
        .toUrl(parameters: {'orgId': '$orgId', 'projectId': '$projectId'}));
  }
