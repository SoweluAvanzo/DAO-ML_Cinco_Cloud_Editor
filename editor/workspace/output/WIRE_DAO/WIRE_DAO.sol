...
contract WIRE_DAO is IPermissionManager {
    ...
    uint32[8] internal all_roles = [
        2112, // #0) Everyday_User -> ID : 0 , control bitmask: 1000010
        2113, // #1) Super-User -> ID : 1 , control bitmask: 1000010
        2114, // #2) Human_Data_Curator -> ID : 2 , control bitmask: 1000010
        6211, // #3) Professional_User -> ID : 3 , control bitmask: 11000010
        6148, // #4) AI_Curator -> ID : 4 , control bitmask: 11000000
        2117, // #5) Collaborator -> ID : 5 , control bitmask: 1000010
 ...
 //Events
    ...
    constructor(
        ...
        role_permissions[1] = 516096; // #1) Super-User 

        role_permissions[2] = 0; // #2) Human_Data_Curator 

        role_permissions[3] = 28416; // #3) Professional_User 

        role_permissions[4] = 0; // #4) AI_Curator 

        role_permissions[5] = 393219; // #5) Collaborator 
