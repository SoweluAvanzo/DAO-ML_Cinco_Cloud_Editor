...
class BusinessPomGenerator extends Generatable{
	...
	<project xmlns="http://maven.apache.org/POM/4.0.0"
	    ...
	    <groupId>info.scce.pyro</groupId>
	    ...
	    <dependencies>
			...
			«FOR g:gc.mglModels»
				«FOR ann:g.annotations.filter[name.equals("pyroAdditionalJAR")]»
				    «FOR v:ann.value»
				        <dependency>
				        	<groupId>info.scce.pyro.external.«g.name.lowEscapeJava»</groupId>
				        	<artifactId>«v.jarFilename»</artifactId>
				        	<version>1.0</version>
				        </dependency>
				    «ENDFOR»
				«ENDFOR»
		...
		«IF gc.mglModels.exists[annotations.exists[name.equals("pyroAdditionalJAR")]]»
			<repositories>
				<repository>
					<id>pyro-repo</id>
					<releases>
